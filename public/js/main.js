!function (e) {
    ...
    }), e("nav#dropdown").meanmenu({siteLogo: "<div class='mobile-menu-nav-back'><a href='/' class='logo-mobile'><img src='../public/img/logo.png'/></a></div>"}), (new WOW).init(), e.scrollUp({
    ...
    i.length && i.validator().on("submit", function (a) {
        var t = e(this), n = i.find(".form-response");
        ...
        var a = e(this), t = a.data("loop"), n = a.data("items"), o = a.data("margin"),
            s = (a.data("stage-padding"), a.data("autoplay")), i = a.data("autoplay-timeout"),
            r = a.data("smart-speed"), l = a.data("dots"), d = a.data("nav"), p = a.data("nav-speed"),
            ...
            h = a.data("r-small"), y = a.data("r-small-nav"), w = a.data("r-small-dots"), b = a.data("r-medium"),
            C = a.data("r-medium-nav"), T = a.data("r-medium-dots"), k = a.data("r-Large"), x = a.data("r-Large-nav"),
        ...
        var a = e("#sticker"), t = a.outerHeight(), n = e(window).scrollTop(), o = e(window).width(),
            s = e("#header-layout1"), i = e("#header-layout2");
        if (o > 991) {
            var r = 1;
            i.length && (r = i.find(".header-top-bar").outerHeight()), n >= r ? (s.length && a.addClass("stick"), i.length && (a.addClass("stick"), e(".main-menu-area").addClass("header-menu-fixed"), e("body").css({"margin-top": t + "px"}))) : (a.removeClass("stick"), i.length && (a.removeClass("stick"), e(".main-menu-area").removeClass("header-menu-fixed"), e("body").css({"margin-top": 0})))
        }
    })
}(jQuery);
