            ...
            <div class="row tab-space1">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="img-overlay-70 img-scale-animate mb-2">
                        <img
                            data-original="@if(isset($latestPostTop->imageGallery)) {{ url('public') }}/{{$latestPostTop->imageGallery->thumbnail}}  @else {{ url('public/default-image/default-100x100.png') }} @endif"
