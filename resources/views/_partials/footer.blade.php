...
<!-- Popper js -->
<script src="{{ asset('public/js/popper.js') }}" type="text/javascript"></script>
<!-- Bootstrap js -->
<script src="{{ asset('public/js/bootstrap.min.js') }}" type="text/javascript"></script>
<!-- WOW JS -->
<script src="{{ asset('public/js/wow.min.js') }}"></script>
<!-- Owl Cauosel JS -->
<script src="{{ asset('public/vendor/OwlCarousel/owl.carousel.min.js') }}" type="text/javascript"></script>
<!-- Meanmenu Js -->
<script src="{{ asset('public/js/jquery.meanmenu.min.js') }}" type="text/javascript"></script>
<!-- Srollup js -->
<script src="{{ asset('public/js/jquery.scrollUp.min.js') }}" type="text/javascript"></script>
<!-- jquery.counterup js -->
