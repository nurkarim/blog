...
@section('content')
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                {!! Form::model($data,['url'=>['themeSettings',$data->id],'id'=>'myForm','method'=>'PUT','files'=>true]) !!}
                <div class="row">
                    <div class="form-group clearfix col-md-6">
                        <label class="control-label">Label
                            <star>*</star>
                        </label>
                        {!! Form::select('label',['top'=>'Top','center'=>'Center','Bottom'],null,['class'=>'form-control','required']) !!}
                    </div>
                    <div class="form-group clearfix col-md-6">
                    ...
                    <div class="form-group clearfix col-md-6">
                        ...
                        <input class="form-control"  name="view_order" type="number" required="true" value="{{ $data->view_order }}" />
                    </div>
                    ...
                    <div class="form-group" id="section-style">
                        ...
                        <div class="row p-l-15">
                            <div class="col-12 col-md-4">
                                <div class="section_section_style">
                                    <label class="custom-control custom-radio custom-control-inline">
                                        <input @if($data->section_style=="style_1") checked="" @endif type="radio" name="section_style" id="section_section_style_1" value="style_1"  class="custom-control-input" data-parsley-multiple="section_style">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="section_section_style">
                                    <label class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" @if($data->section_style=="style_2") checked="" @endif name="section_style" id="section_section_style_2" value="style_2" class="custom-control-input" data-parsley-multiple="section_style">
                                        <span class="custom-control-label"></span>
                                    </label>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="section_section_style">
                                    <label class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" @if($data->section_style=="style_3") checked="" @endif name="section_style" id="section_section_style_3" value="style_3" class="custom-control-input" data-parsley-multiple="section_style">
                                        <span class="custom-control-label"></span>
                                    </label>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="section_section_style">
                                    <label class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" @if($data->section_style=="style_4") checked="" @endif name="section_style" id="section_section_style_4" value="style_4" class="custom-control-input" data-parsley-multiple="section_style">
                                        <span class="custom-control-label"></span>
                                    </label>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="section_section_style">
                                    <label class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" @if($data->section_style=="style_5") checked="" @endif name="section_style" id="section_section_style_5" value="style_5" class="custom-control-input" data-parsley-multiple="section_style">
                                        <span class="custom-control-label"></span>
                                    </label>
