            ...
            <div class="modal-body">
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="form-group text-center">
                                    <img src="{{ asset('public/default-image/default-100x100.png') }} " id="perview_current_image"
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="ajax-loading" id="ajax-image-loading"><img src="{{ asset('public/img/preloader-2.gif') }}"/>
                        </div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data[0].status == 'success') {
                        ...
                        @endif);
                        $('#perview_current_image').attr('src', "{{asset('public/default-image/default-100x100.png') }}");
