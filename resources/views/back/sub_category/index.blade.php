                    ...
                    <table id="dataTable" class="display table" style="width: 100%; cellspacing: 0;">
                        ...
                        @foreach($categories as $data)
                            <tr>
                                ...
                                <td>
                                    <button type="button"   data-toggle="modal" data-target="#modal" onclick="loadModal('{{route('subcategories.edit',$data->id)}}')"  class="btn btn-info btn-xs"><i class="fa fa-edit"></i></button>
                                    {!! Form::open(['url' => ['subcategories', $data->id],'method'=>'DELETE','style'=>'display:inline;']) !!}
