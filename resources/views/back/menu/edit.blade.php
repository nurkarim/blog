...
<div class="row">
    <div class="col-md-12 row">
        ...
        {!! Form::model($menu,['url'=>['menu-items',$menu->id],'id'=>'myForm','method'=>'PUT','files'=>true]) !!}
        ...
        <div class="row">
            ...
            <div class="form-group clearfix col-md-6">
                ...
                <input class="form-control" value="{{ $menu->view_order }}"  name="view_order" type="number" required="true" />
            </div>
